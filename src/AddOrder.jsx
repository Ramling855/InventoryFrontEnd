...
const AddOrder = () => {
  ...
  const OnbuybtnHandle = async (e) => {
    ...
    if (e.qty < 1) {
      ...
      await axios
        .post("https://ramlinginventory.herokuapp.com/order", data)
        .then((res) => {
          alert("Order Placed");
  ...
  const onSerachHandle = (e) => {
    ...
    console.log(key);
    axios
      .get(`https://ramlinginventory.herokuapp.com/search/${key}`)
      .then((res) => {
        setRows(res.data);
  ...
  const sortHandle = async () => {
    ...
    await axios
      .get(`https://ramlinginventory.herokuapp.com/sort/?num=${sort}`)
      .then((res) => {
        setRows(res.data);
        console.log(res.data);
      })
